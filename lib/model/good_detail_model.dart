class GoodDetailModel {
  ...
  GoodDetailModel({this.code, this.message, this.data});

  GoodDetailModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new GoodData.fromJson(json['data']) : null;
  }
...
class GoodData {
  ...
  GoodData({this.goodInfo, this.goodComments, this.advertesPicture});
